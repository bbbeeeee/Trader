 ...
 * Application routes.
 */
app.all('*', homeController.loggedIn);
app.get('/', homeController.index);
/**
 * Buy and sell routes
 **/
app.get('/needed', homeController.buy);
app.post('/needed/new', buyController.newBuy);
app.get('/sell', homeController.sell);
app.post('/sell/new', sellController.newSell);
app.get('/new', homeController.newPage);
